...
# Apply 2 hidden layers as MLP neuron1: 4096, neuron2: 4096
network.fc = nn.Sequential(nn.Linear(512,600), nn.Linear(600,600),nn.Linear(600,100))
...
for name, param in network.named_parameters():
    if name in ['fc.0.weight', 'fc.0.bias', 'fc.1.weight', 'fc.1.bias', 'fc.2.weight', 'fc.2.bias']:
