...
network1 = torch.load('model_weights.pth').to(device)
...
for i, data in enumerate(train_loader):
    ...
    if i == 0:
        stage4_out_train_stacking = stage4_out_train
        stage4_label_train_stacking = stage4_label_train
    else:
        stage4_out_train_stacking = np.vstack((stage4_out_train_stacking,stage4_out_train))
        stage4_label_train_stacking = np.append(stage4_label_train_stacking,stage4_label_train)
...
for i, data in enumerate(test_loader):
    ...
    if i == 0:
        stage4_out_test_stacking = stage4_out_test
        stage4_label_test_stacking = stage4_label_test
    else:
        stage4_out_test_stacking = np.vstack((stage4_out_test_stacking,stage4_out_test))
        stage4_label_test_stacking = np.append(stage4_label_test_stacking,stage4_label_test)
...
plt.subplot(1,4,3)
plt.scatter(stage4_out_train_stacking[:,0], stage4_out_train_stacking[:,1], c = stage4_label_train_stacking, cmap='rainbow')
plt.colorbar()
plt.title('training')
plt.xlabel('neuron 1')
plt.ylabel('neuron 2')
...
plt.subplot(1, 4, 4)
plt.scatter(stage4_out_test_stacking[:,0], stage4_out_test_stacking[:,1], c = stage4_label_test_stacking, cmap='rainbow')
plt.colorbar()
plt.title('testing')
plt.xlabel('neuron 1')
plt.ylabel('neuron 2')
